...
do not look negatively on you if we find the incident is not a violation.
...
3. **Be specific** about the behavior that violated the Code of Conduct
4. **Include any relevant links** or screenshots

### What Happens After You Report

1. **Acknowledgment**: You will receive an acknowledgment within 48 hours
2. **Investigation**: The incident will be investigated thoroughly
3. **Decision**: A decision will be made about appropriate action
...
will be announced through the project's communication channels.

---

**Note**: This Code of Conduct applies to all community interactions related to
the LLM Health Evaluation project, including but not limited to GitHub issues,
discussions, pull requests, and any other project-related communications.
